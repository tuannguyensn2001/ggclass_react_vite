...
function MemberTableContentItem({avatar,name,school,classes,phone,handleOpenModalEdit=()=>{},handleOpenModalDelete=()=>{}}) {
    return (
        <div className={styles.wrap}>
            ...
            <div className={styles.item}>
                ...
                <div className={styles.path_6}>
                    <div className={styles.icon} onClick={handleOpenModalDelete}>
...
export default MemberTableContentItem;