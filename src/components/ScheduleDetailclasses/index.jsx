...
function ScheduleDetailclasses({data}) {
    return (
        <div className={styles.wrap}>
            ...
            <div className={styles.bottom_item}>
                ...
                <div className={styles.bottom_item}>
                    <div className={styles.icon_bottom_wrap}>
                        <img className={styles.icon_bottom} src='https://shub.edu.vn/images/icons/schedule_offline.svg'/>
                    </div>
                    <div className={styles.text}>
                        Loại phòng: Offline    
                    </div>
