...
function CommentWrite({postId,handleCreateComment}) {
    ...
    return (
        <Box component='form' onSubmit={handleSubmit(onSubmit)} className={styles.cover_input}>
            ...
            <div className={styles.input}>
                <TextField name='content' {...register('content')}  size="small" fullWidth  className={styles.input_text} placeholder="Viết bình luận ..." type="text"/>
            </div>
        </Box>
    );
}
