...
function MemberModalDeleteStudent({
    nameDelete,
        ...
        <div>
            ...
            >
                <Box sx={style} className={styles.box}>
                    ...
                    <div className={styles.content}>Học sinh {nameDelete} sẽ bị xóa khỏi danh sách lớp!</div>
                    <div className={styles.footer}>
                        <button className={clsx(styles.button, styles.cancel)}>Thoát</button>
                        <button onClick={handleDeleteUser} className={clsx(styles.button, { [styles.active]: true })}>
                            Đồng ý
                        </button>
                    </div>
                </Box>
