...
const defaultData = [
    {
        id: 1,
        content: 'Level up your understanding of React Router with the concepts, vocabulary, and design principles of React Router and routing in general. A must read for would-be contributors.',
        createdBy: 3,
        createdByUser: {
            id : 4,
...
function Newsfeed() {
    ...
    // const {data} = useQuery('getPost',async()=>{
    //     const res = await API.get(`/v1/classes/:${postId}/posts`)
    //     return res.data;
    // },{
    //     onSuccess(data) {
    ...
    return (
        <div className={styles.wrap}>
            <div className={styles.content}>
                <NewsfeedHeader/>
                <NewsfeedContent handleCreateComment={handleCreateComment} handleCreatePost={handleCreatePost} data={listPost}/>
            </div>
